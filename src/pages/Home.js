                ...
                <div className="notice_post borderR">
                  <a className="a_tag" href="http://naver.com">
                    <p className="notice_post_Title">
                      카카오 서비스 약관 변경 안내 카카오 서비스 약관 변경 안내
                    </p>
                    <p className="notice_post_Inner">
                      {" "}
                      Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                      Commodi adipisci accusantium magnam repellat facilis modi
                      quibusdam consectetur ipsa veniam. Molestiae hic
                      dignissimos itaque veritatis minima iusto voluptates
                      veniam? Dignissimos, adipisci. Lorem ipsum dolor sit, amet
                      consectetur adipisicing elit. Blanditiis necessitatibus
                      inventore repellat voluptatum atque nemo, repellendus
                      saepe illum nobis. Consequatur, aliquam? Quasi nostrum
                      placeat saepe inventore nemo, dicta quas aperiam.
                    </p>
